...
exports.createSession = async (req, res) => {
  try {
    const { title, description, teacherId, learnerIds, gmeetLink, scheduledTime, duration } = req.body;
...
exports.getUserSessions = async (req, res) => {
  try {
    ...
    const sessions = await Session.find({ $or: [{ teacher: userId }, { learners: userId }] });
