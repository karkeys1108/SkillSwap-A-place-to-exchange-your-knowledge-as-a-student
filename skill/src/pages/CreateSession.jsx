  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        teacherId: user?._id || JSON.parse(localStorage.getItem('user'))?._id,
        learnerIds: [],
        scheduledTime: formData.sessions?.[0]?.date || new Date().toISOString(),
        duration: Number(formData.duration) || 60,
        gmeetLink: formData.sessions?.[0]?.meetingLink || ''
      };
                        ...
                        <FormControlLabel
                          control={
                            <Switch
                              ...
                              onChange={(e) => handleSessionChange(index, 'isRecurring', e.target.checked)}
                              color="primary"
                            />
                          }
                          ...
                          <Grid item xs={12} md={6}>
                            <FormControl fullWidth>
                              ...
                              <Select
                                ...
                                onChange={(e) => handleSessionChange(index, 'recurringPattern', e.target.value)}
